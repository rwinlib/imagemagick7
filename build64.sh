...
export CPPFLAGS="-m64 -I/c/msys2-x64/mingw64/include -DLIBXML_STATIC -DLIBXML_STATIC -DGLIB_STATIC_COMPILATION"
export CFLAGS="-m64 -I/c/msys2-x64/mingw64/include -DLIBXML_STATIC -DLIBXML_STATIC -DGLIB_STATIC_COMPILATION"
export CXXLAGS="-m64 -I/c/msys2-x64/mingw64/include -DLIBXML_STATIC -DLIBXML_STATIC -DGLIB_STATIC_COMPILATION"
